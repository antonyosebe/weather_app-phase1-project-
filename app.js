...
//click event listener for cities in the panel
cities.forEach((city) => {
...
function fetchWeatherData() {
    fetch(`http://api.weatherapi.com/v1/current.json?key=cd6037b1e396470085482241222312&q=${cityInput}`)
        ...
        .then(data => {
            ...
            //changes to night if its night time in the city
